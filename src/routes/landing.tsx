...
export default function FortisignLanding() {
    ...
    return (
        <>
            <Helmet>
                <title>Fortis — Secure Solana Multisig for Solana DAOs</title>
                <meta
                    name="description"
                    content="Fortis is a security-first multisig for Solana DAOs, protecting treasuries from blind signing, address poisoning, and high-stake exploits."
                />
            </Helmet>
