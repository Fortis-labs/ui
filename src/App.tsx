    ...
    <NetworkProvider>
      <QueryClientProvider client={queryClient}>
        <Wallet>
          <HashRouter>
            <Routes>
              {/* Default route: show landing page at "/" */}
              <Route path="/" element={<FortisignLanding />} />

              {/* Explicitly keep /landing if you want it accessible via that URL too */}
              <Route path="/landing" element={<FortisignLanding />} />

              {/* All other routes use the main app layout (with TabNav, etc.) */}
              <Route
                path="/*"
                element={
